...
//////////////////////////////////////////////////////////////////////////////////////////////
//
// Let's begin with some Teensy-MIDI-Audio specific options
//
//
...
//#define OPTION_SIDETONE_VOLUME     0.1  // initial side tone volume
...
// If OPTION_MIDI_CONTROL_CHANNEL is not defined, channel 2 will be listened to
...
// If OPTION_ROUTE_AUDIO_BACK     is not defined not audio routing back to the USB will be performed
// If OPTION_TRAILING_MUTE        is not defined zero will be used (no muting)
//
//
// Now come the standard K3NG keyer option
//
//////////////////////////////////////////////////////////////////////////////////////////////
